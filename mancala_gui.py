...
class MancalaGui(object):
    ...
    def mouse_pressed(self,event):
        ...
        try:
            ...
            if not get_possible_moves(self.game.board, self.game.current_player):
                ...
                self.draw_board()
                winner = "Player A" if (self.game.board.mancalas[0] > self.game.board.mancalas[1]) else "Player B" 
    ...
    def draw_board(self):
        ...
        self.score_label["text"]= "Player A {} : {} Player B".format(*self.game.board.mancalas) 
